...
from utils import train_DVS_Time
...
parser.add_argument('-out-dir', default='/Volumes/export/isn/keli/code/HS/CRI_Mapping/output/dvs_gesture', type=str, help='dir path that stores the trained model checkpoint')
...
def main():
    ...
    net = DVSGestureNet(channels=args.channels, spiking_neuron=neuron.IFNode, surrogate_function=surrogate.ATan(), detach_reset=True)
