...
class SSA(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., sr_ratio=1):
        ...
        self.attn = LocalAttention(
          ...
          window_size = self.dim//self.num_heads//3,       # window size. 512 is optimal, but 256 or 128 yields good enough results
    ...
    def forward(self, x):
        ...
        v = v_linear_out.reshape(T, B, N, self.num_heads, C//self.num_heads).permute(0, 1, 3, 2, 4).contiguous() #T, B, num_heads, N, c//num_heads
