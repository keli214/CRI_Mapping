...
#                  embed_dims=384, num_heads=4, mlp_ratios=4, qkv_bias=False, qk_scale=None,
...
def main():
    ...
    if torch.cuda.is_available():
        net.to(device)
    checkpoint_path = "/Volumes/export/isn/gopa/CRI_proj/cri_spikeformer/cifar10/output/train/20230301-194515-spikformer-32/checkpoint-309.pth.tar"
